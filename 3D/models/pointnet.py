...
class PointNetSeg(nn.Module):
    ...
    def forward(self, x, cls):
        ...
        n_pts = x.size()[2]
        x1 = self.bn1(F.relu(self.conv1(x))) # Bx64xN
        x2 = self.bn2(F.relu(self.conv2(x1))) # Bx128xN
        x3 = self.bn3(F.relu(self.conv3(x2))) # Bx128xN
        x4 = self.bn4(F.relu(self.conv4(x3))) # Bx128xN
